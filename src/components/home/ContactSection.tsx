...
export default function ContactSection() {
  return (
    <section className="w-full mx-auto px-4 md:px-10 gap-8 flex flex-col md:flex-row items-center justify-center">
      <div className="w-full flex flex-col">
        <h1 className="w-full justify-start items-center text-4xl text-primary">Get In Touch</h1>
